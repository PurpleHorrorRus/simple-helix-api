...
class Static {
        ...
        const request = async params => {
            if (typeof broadcaster_id === "object") {
                if (Array.isArray(broadcaster_id)) {
                    ...
                    return await context[builder](...Object.values(broadcaster_id), params);
                }
            } else return await context[builder](broadcaster_id, params);
        }

        let response = await request({ first: 100 });
    ...
    async requestCustom(endpoint, broadcaster_id, params = {}, requestOptions = { method: "GET" }) {
        ...
        return await this.requestEndpoint(endpoint, { broadcaster_id, ...params }, requestOptions);
    }
